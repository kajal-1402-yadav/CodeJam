const Navbar = () => {
    return (
        <header className="sticky bg-[#1E1E1E] top-0 z-50 w-full border-b border-gray-800/50 backdrop-blur-sm">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
                ...
                <nav className="hidden items-center gap-8 md:flex">
                    <a className="text-sm font-medium text-gray-300 hover:text-[#A78BFA]" href="#">Features</a>
                    <a className="text-sm font-medium text-gray-300 hover:text-[#A78BFA]" href="#">How It Works</a>
                    <a className="text-sm font-medium text-gray-300 hover:text-[#A78BFA]" href="#">Contact</a>
                </nav>
