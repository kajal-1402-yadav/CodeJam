        ...
        <header className="sticky bg-[#1a1818] top-0 z-50 w-full border-b border-gray-800/50 backdrop-blur-sm">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-2">
                    <button className="rounded-xl bg-[#A78BFA]/20 px-4 py-2 text-sm font-bold text-[#A78BFA] hover:bg-[#A78BFA]/30">
                        <Link to="/signup">Signup</Link></button>
                    <button className="rounded-xl bg-[#A78BFA] px-5 py-2 text-sm font-bold text-background-dark hover:bg-[#A78BFA]/90">
